...
export default function Select() {
  const images = ["./144p.jpg", "./360p.jpg", "./720p.jpg", "./1080p.jpg"];
  ...
  return (
    <div className="select_option">
      ...
      <button onClick={handlePlayPause} className="audio_btn">
        <i
          className={`fa-solid ${
            isPlaying ? "fa-volume-xmark" : "fa-volume-high"
          } animate-volume`}
        ></i>
      </button>
      ...
      <select onChange={handleChange}>
        ...
        <option value="" onClick={handlePlayPause}>
          1080p
        </option>
      </select>
      ...
      <div className="select_img">
        {!showSlider && selectedImage && (
          <img className="img" src={selectedImage} alt="Selected Quality" />
        )}
        {showSlider && <Slider />}
      </div>
